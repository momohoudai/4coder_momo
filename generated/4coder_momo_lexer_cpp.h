...
TokenCppKind_Less = 48,
TokenCppKind_ParenCl = 49,
TokenCppKind_BrackCl = 50,
TokenCppKind_Grtr = 51,
TokenCppKind_Semicolon = 52,
TokenCppKind_Colon = 53,
TokenCppKind_DotDotDot = 54,
TokenCppKind_ColonColon = 55,
TokenCppKind_PlusPlus = 56,
TokenCppKind_MinusMinus = 57,
TokenCppKind_Dot = 58,
TokenCppKind_Arrow = 59,
TokenCppKind_Plus = 60,
TokenCppKind_Minus = 61,
TokenCppKind_Not = 62,
TokenCppKind_Tilde = 63,
TokenCppKind_Star = 64,
TokenCppKind_And = 65,
TokenCppKind_DotStar = 66,
TokenCppKind_ArrowStar = 67,
TokenCppKind_Div = 68,
TokenCppKind_Mod = 69,
TokenCppKind_LeftLeft = 70,
TokenCppKind_RightRight = 71,
TokenCppKind_Compare = 72,
TokenCppKind_LessEq = 73,
