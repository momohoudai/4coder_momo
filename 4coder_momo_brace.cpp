...
static void
momo_render_brace_highlight(Application_Links *app, Buffer_ID buffer, Text_Layout_ID text_layout_id,
...
static void
momo_render_close_brace_annotation(Application_Links *app, Buffer_ID buffer, Text_Layout_ID text_layout_id,
                                    i64 pos)
{
...
static void
momo_render_brace_lines(Application_Links *app, Buffer_ID buffer, View_ID view,
                     Text_Layout_ID text_layout_id, i64 pos)
{
    ...
    for (i32 i = ranges.count - 1; i >= 0; i -= 1)
    {
        ...
        line_rect.x0 = x_position+x_offset-0.75f;
        line_rect.x1 = x_position+x_offset+0.75f;
